...
considered
useful](@/posts/web-frameworks-considered-useful.md).
...
already](@/posts/the-new-hot-thing-in-web-development-client-side-templating-languages.md).
...
[components](@/posts/the-core-of-obviel.md)
you could [compose
together](@/posts/powerful-composition-with-obviel-data-render.md).
We created a client-side [form
library](http://www.obviel.org/en/1.0/form.html) based on that. In 2011
we released this as
[Obviel](@/posts/obviel.md).
...
conference](@/posts/jsconf-eu-2013-impressions.md)
...
2014](@/posts/my-visit-to-europython-2014.md)
that I think works better as an introduction.

I [announced Morepath on my
blog](@/posts/on-the-morepath.md):
...
support for server
templates](@/posts/morepath_templating.md).
...
[React Europe
2015](@/posts/thoughts-about-react-europe.md)
and [React Europe
2016](@/posts/impressions-of-react-europe-2016.md).
...
work
on](@/posts/looking-for-new-challenges.md).
